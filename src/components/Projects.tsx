...
const projects: Project[] = [
    ...
    },
    {
        ...
        category: "E-Commerce Platform",
        type: "software",
        description: "A feature-rich Magento 2 e-commerce platform for an automotive parts retailer, built on a Hyvä theme. Work spanned the full stack — from a deeply customised Algolia search integration with vehicle fitment filtering, to purchase order cost management. The store also used a support application for catalog import, built using Laravel and MongoDB. It combined import from different vendors and utilising tecdoc API integration for vehicle data.",
        highlights: [
